...
def main(args):
    ...
    for epoch in range(args.num_epochs):
        for i, (images, captions, lengths) in enumerate(data_loader):
            ...
            # forward and backward propagation and optimize using Adam (Adaptive Moment)
            ...
            if i % args.log_step == 0:
                print('Epoch [{}/{}], Loss: {:.4f}, Perplexity: {:5.4f}'.format(epoch, args.num_epochs, i, total_step, loss.item(), np.exp(loss.item())))
